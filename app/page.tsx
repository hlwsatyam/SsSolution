                    ...
                    <div className="relative md:mt-24 mx-auto w-full max-w-4xl pt-4 text-center">
                        <div className="justify-center hidden md:flex">
                            <div
                                ...
                                <Badge className="font-semibold">Start</Badge>
                                <h5>Start Your Online Services</h5>
                        ...
                        <h1 className="md:text-7xl my-4 font-extrabold text-4xl md:leading-tight">Boost Business With Advance WEB APP LEAD SOCIAL MEDIA marketing</h1>
                        <p className="mx-auto my-4 text-sm w-full max-w-xl text-center font-medium leading-relaxed tracking-wide">
                        Supercharge your business with cutting-edge web apps and advanced social media marketing. Our solution is designed to elevate your brand, drive leads, and enhance customer engagement. Whether you're launching a product, service, or app, this template built with Next.js, Tailwind CSS, and TypeScript is easy to customize and perfect for your marketing needs.
                        </p>
